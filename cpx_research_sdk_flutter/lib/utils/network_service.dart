...
class NetworkService {
  ...
  Map<String, dynamic> getRequestParameter() {
    ...
    String version =
        "0.4.1"; //  The package_info_plus package just shows the app version not the package version and adding the pubspec.yaml to the assets is a security issue for flutter web.
    return {
